...
module.exports = function (t) {
  ...
  loadGlobal([
    "localDate", "todayLocal", "humanDate", "stepsIn", "openStepsIn", "practices",
  ...
  function reset() {
    state.steps = [
      { id: "a", storyId: "q1", title: "Oldest", status: "open", createdAt: "2026-01-01T09:00:00Z" },
      { id: "b", storyId: "q2", title: "Newest", status: "open", createdAt: "2026-06-01T09:00:00Z" },
      { id: "c", storyId: "q1", title: "A practice", status: "open", mode: "practice", createdAt: "2026-05-01T09:00:00Z" },
      { id: "d", storyId: "q1", title: "Already done", status: "complete", createdAt: "2026-03-01T09:00:00Z" },
      { id: "e", storyId: "qPaused", title: "In a paused story", status: "open", createdAt: "2026-04-01T09:00:00Z" },
      { id: "f", storyId: "q1", title: "Legacy, no createdAt", status: "open" }
    ];
    state.journey = [];
    nav = [];
    global.currentStory = null;
  ...
  reset();
  completeStep("a");
  t.ok("the step completes", state.steps[0].status === "complete");
  ...
  global.currentStory = "q1";
  markPractice("c");
  t.ok("the practice stays open", state.steps[2].status === "open");
